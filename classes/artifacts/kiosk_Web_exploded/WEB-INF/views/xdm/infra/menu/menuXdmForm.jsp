               ...
               <form class="submitForm" name="form" method="post">
				   <table class="table">
	                ...
	                <tr>
		                ...
		                <td><input type="text" class="form-control" id="soldOutNy" name="soldOutNy" required value="<c:out value="${item.soldOutNy}"/>"></td>
					</tr>
	                </tbody>
              		</table>
  ...
  $("#submitBtn").on("click",function(){
	/*   	if(validationInst() == false) return false;  */
	   ...
	   // 	alert("저장완료");	
	 	...
	 	$("form[name=form]").attr("action","/menuInsert").submit();
...
/* 	  
	  ...
	  $("#deleteBtn").on("click",function(){
	 		...
	 		$("form[name=form]").attr("action","/menuDel").submit();
	  ...
	  $("#ueleteBtn").on("click",function(){
	 		...
	 		$("form[name=form]").attr("action","/menuUele").submit();
