                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="sm" name="formList" method="post">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <c:forEach items="${list}" var="list" varStatus="status">
                                            <tr>
                                                <td><a href="orderForm?seq=<c:out value="${list.orderSeq}"/>"><c:out value="${list.orderSeq}"/></a></td>
                                                <td><c:out value="${list.totalPrice}"></c:out></td>
                                                <td><c:out value="${list.orderTime}"></c:out></td>
                                                <td><c:out value="${list.orderList_seq}"></c:out></td>
                                            </tr>
                                        </c:forEach>
                                    </c:otherwise>
                                </c:choose>
                            ...
                            <a href="orderForm"><button type="button" class="btn btn-primary" id="insertBtn">추가</button></a>
...
<script type="text/javascript">
    $("#btn").on("click", function(){
        ...
        $("form[name=formList]").attr("action", "/orderXdmList").submit();
