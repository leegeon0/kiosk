                    ...
                    <div class="card-body">
                        ...
                        <form class="submitForm" name="form" method="post">
                            <table class="table">
                                <thead>
                                <tr>
                                    <th scope="col">orderSeq</th>
                                    <th scope="col">totalPrice</th>
                                    <th scope="col">orderTime</th>
                                    <th scope="col">orderList_seq</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <td><input type="text" class="form-control" id="orderSeq" name="orderSeq" placeholder="Auto Increment" required readonly value="<c:out value="${item.orderSeq}"/>"></td>
                                    ...
                                    <td><input type="text" class="form-control" id="orderList_seq" name="orderList_seq" value="<c:out value="${item.orderList_seq}"/>"></td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <c:choose>
                                <c:when test="${empty item.orderSeq}">
  ...
  if(validationUpdt() == false) return false;
   ...
   validationUpdt = function(){
    ...
    $("#submitBtn").on("click",function(){
        ...
        $("form[name=form]").attr("action","/orderInsert").submit();
    });
    ...
    $("#updateBtn").on("click",function(){
        ...
        /* if(validationUpdt() == false) return false; */
        $("form[name=form]").attr("action","/orderUpdt").submit();
    });
    ...
    $("#deleteBtn").on("click",function(){
        ...
        $("form[name=form]").attr("action","/orderDelt").submit();
