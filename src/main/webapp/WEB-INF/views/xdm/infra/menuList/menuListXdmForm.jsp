               ...
               <form class="submitForm" name="form" method="post">
				   <table class="table">
	                ...
	                <tr>
              		...
              		<c:choose>
						<c:when test="${empty item.menuListSeq }">
  ...
  $("#submitBtn").on("click",function(){
	/*   	if(validationInst() == false) return false;  */
	   ...
	   // 	alert("저장완료");	
	 	...
	 	$("form[name=form]").attr("action","/menuListInsert").submit();
	 	 
	  });
  

	  $("#updateBtn").on("click",function(){
		 $("form[name=form]").attr("action","/menuListUpdt").submit(); 
	  });
		 
	  
	  $("#deleteBtn").on("click",function(){
	 		$("form[name=form]").attr("action","/menuListDel").submit();

	 		 
	 });
	  
	  $("#ueleteBtn").on("click",function(){
	 		$("form[name=form]").attr("action","/menuListUele").submit();
